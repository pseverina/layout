<template>
  <div class="footer">
      ...
      <ul class="footer__list">
        ...
        <li class="footer__list-components">Автоматизация процессов
          <ul class="footer__nest-list">
            ...
            <li class="footer__nest-list-components">Анализ геоданных</li>
            <li class="footer__nest-list-components">Видеонаблюдение (Larga)</li>
            <li class="footer__nest-list-components">Мобильные сотрудники</li>
        ...
        <li class="footer__list-components">IT и безопасность
          <ul class="footer__nest-list">
            ...
            <li class="footer__nest-list-components">Видеонаблюдение</li>
            <li class="footer__nest-list-components">Виртуальный сервер</li>
          </ul>
        </li>
    ...
    <!-- <h5 class="footer__title">Бизнес маркет</h5>
    <p class="footer__subtitle">Покупайте бизнес сервисы онлайн, оплатив с мобильного счета вашей организации</p>
    <ul class="footer__list">
      <li class="footer__list-components">Помощь
        <ul>
          <li>Обратная связь</li>
          <li>Контакты</li>
          <li>Политика обработки cookie</li>
          <li>Перейти на сайт mts.ru</li>
        </ul>
      </li>
      <li class="footer__list-components">Реклама и продвижение</li>
      <li class="footer__list-components">Автоматизация процессов</li>
